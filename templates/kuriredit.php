  ...
  <?php include '../connector/con_myjob.php'; ?>
    ...
    <div class="action">
      ...
      <div class="menu " >
        ...
        <ul class="">
          <li><img src="../img-stocks/user.png" alt=""></img><a href="../templates/profilkurir.php">Profil</a></li>
          <li><img src="../img-stocks/edit.png" alt=""></img><a href="../templates/profileditkurir.php">Edit Profil</a></li>
